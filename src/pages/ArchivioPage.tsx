...
import { Home, Pencil, Copy, Trash2, Search, FilePenLine } from 'lucide-react';
import { 
  Dialog, 
  DialogContent, 
  DialogHeader, 
              ...
              <TableRow key={offerta.id} className="border-white/10 hover:bg-black/10">
                ...
                <TableCell className="text-center">
                  <div className="flex items-center justify-center gap-1">
                    <Button variant="ghost" size="icon" onClick={() => duplicaOfferta(offerta)} title="Duplica e Modifica">
                      <Copy className="h-4 w-4 text-gray-400 hover:text-blue-500 transition-colors" />
                    </Button>
                    <Button variant="ghost" size="icon" onClick={() => riapriOfferta(offerta)} title="Riapri e continua a modificare">
                      <FilePenLine className="h-4 w-4 text-gray-400 hover:text-green-500 transition-colors" />
                    </Button>
                    <Button variant="ghost" size="icon" onClick={() => handleOpenDeleteDialog(offerta)} title="Elimina Offerta">
