...
export const QuotePreview = forwardRef<HTMLDivElement, QuotePreviewProps>(({
  ...
  // Shared: Date + Signatures
  const renderDateAndSignatures = () => (
    <>
    ...
    <div ref={ref} className="bg-white text-gray-900 min-h-full" style={{
      ...
      <div style={{
        ...
        <h1 style={{
          ...
          {isModulo ? 'MODULO D\'ORDINE' : 'PROPOSTA COMMERCIALE'}
        </h1>
        <p style={{
      ...
      <div style={{ marginTop: 0, padding: '0 12mm', position: 'relative', boxSizing: 'border-box' }}>
        ...
        {isModulo ? (
          /* MODULO: directly to date + signatures */
          renderDateAndSignatures()
        ) : (
          /* STANDARD: full legal sections then date + signatures */
          <>
            ...
            <div className="mb-6">
              <h3 className={sectionTitleStyle}>5. CERTIFICAZIONI</h3>
              <div className={legalTextStyle + " space-y-2"}>
                <p>MACNIL nel presentare la propria offerta tecnico/economica comunica che, nell'intento di garantire ai propri Clienti un livello di qualità elevato nella fornitura dei propri servizi di progettazione, realizzazione, assistenza tecnica e manutenzione, ha elaborato un Sistema Integrato di Gestione ISO 9001/14001/27001 con Linee Guida 27017 e 27018, oltre che tutte le certificazioni di seguito riportate:</p>
                <p className="text-[9px] text-gray-500 italic">(ISO 9001, ISO 14001, ISO 27001, ISO 27017, ISO 27018, ESG Impact, Rating Impresa 5.0, Tinexta Certified)</p>
              </div>
            </div>

            {/* SEZIONE 6: MANUTENZIONE E GARANZIA */}
            <div className="mb-6">
              <h3 className={sectionTitleStyle}>6. MANUTENZIONE E GARANZIA</h3>
              <div className={legalTextStyle + " space-y-2"}>
                <p>MACNIL garantisce il buon funzionamento dei servizi abilitati, l'assenza di vizi o difetti per tutto il periodo contrattuale.</p>
                <p>Il fornitore MACNIL presterà all'utente, direttamente, l'assistenza tecnica sui prodotti forniti e servizi abilitati.</p>
                <p>La MACNIL si impegna ad offrire all'utente finale un servizio di Assistenza Tecnica, a mezzo telefono e whatsapp, mettendo a disposizione il recapito del proprio Customer Care, <strong>(080.246.42.45)</strong> attivo dal lunedì al venerdì, dalle 8:30 alle 18:30. Assistenza Tecnica attiva H24 con apertura Ticket attraverso il tasto Help all'interno dell'home page della piattaforma. Il canone mensile include la manutenzione correttiva e l'adeguamento normativo, ma non include le personalizzazioni richieste dall'utente.</p>
                <p>Nel caso in cui tali vizi/difetti o il non corretto funzionamento degli apparecchi vengano scoperti nel corso del periodo di garanzia e non siano imputabili all'utente per dolo o colpa grave, i vizi o difetti dovranno essere eliminati o i prodotti dovranno essere sostituiti o riparati a completa cura e spese della MACNIL. Sono a carico dell'utente le spese di spedizione verso MACNIL, mentre le spese di spedizione da MACNIL all'utente sono a carico di MACNIL. La spedizione dovrà avvenire entro 10 giorni dalla comunicazione di autorizzazione sostituzione. In mancanza di restituzione entro il termine indicato, l'utente dovrà versare l'importo di € 390,00 + IVA per ogni dispositivo. Il termine di denuncia di vizi/difetti è di 8 giorni dalla data della scoperta.</p>
              </div>
            </div>

            {/* SEZIONE 7: TRATTAMENTO DATI - GDPR */}
            <div className="mb-6">
              <h3 className={sectionTitleStyle}>7. TRATTAMENTO DATI PERSONALE DEI CLIENTI – GDPR - LEGGE SULLA PRIVACY</h3>
              <div className={legalTextStyle + " space-y-2"}>
                <p>Si precisa che i dati presenti nella Banca Dati del Cliente sui Server della MACNIL, li potrà utilizzare solo il Cliente. Inoltre, tali dati non saranno ceduti a terzi o utilizzati per fini diversi da quelli per i quali il Cliente si impegna a imputarli sui server della MACNIL o trasmetterli alla MACNIL per importazione.</p>
                <p>Ai sensi dell'art. 13 del D. Lgs. 196/2003 (Codice Privacy) e dell'art. 13 del Regolamento UE n. 2016/679 (GDPR 2016/679), recante disposizioni a tutela delle persone e di altri soggetti rispetto al trattamento dei dati personali, i dati personali forniti dal cliente formeranno oggetto di trattamento nel rispetto della normativa sopra richiamata.</p>
              </div>
            </div>

            {/* SEZIONE 8: CONTROVERSIE */}
            <div className="mb-6">
              <h3 className={sectionTitleStyle}>8. CONTROVERSIE</h3>
              <div className={legalTextStyle}>
                <p>Il presente contratto è disciplinato e interpretato secondo la legge italiana. Per qualsiasi controversia che dovesse sorgere tra le parti in ordine all'esistenza, alla validità, all'efficacia, all'interpretazione, all'esecuzione e/o estinzione del presente contratto e/o dei suoi allegati sarà competente in via esclusiva il <strong>Foro di Bari</strong>, con ciò escludendo specificatamente la competenza di fori alternativi ex artt. 18, 19 e 20 codice procedura civile.</p>
              </div>
            </div>
