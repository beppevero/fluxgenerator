    ...
    return (
      ...
      >
        ...
        <div className="p-6 min-h-[600px] flex flex-col" style={{ pageBreakAfter: 'always' }}>
          ...
          {/* Footer pagina 1 */}
          <div className="mt-auto pt-3 border-t border-gray-200 text-[9px] text-gray-400 text-center">
          ...
          <div className="mb-6 pt-4 border-t border-gray-200">
            ...
            {clientData.partitaIva && (
              <div className="mt-4 text-center text-[10px] text-gray-600">
                <p>
                  Dati Fatturazione: <strong>{ragioneSociale}</strong> — P.IVA: <strong>{clientData.partitaIva}</strong>
                </p>
              </div>
            )}
          </div>
