...
export interface Service {
  ...
  nome: string;
  descrizione: string;
  categoria: 'dispositivi' | 'fleet_base' | 'fleet_gold' | 'fleet_plus' | 'fleet_premium' | 'crono' | 'crono_plus' | 'crono_gold' | 'crono_premium' | 'servizio_rimorchi' | 'tractor' | 'asset' | 'piattaforme' | 'servizi_aggiuntivi' | 'centrale_operativa' | 'accessori' | 'software' | 'cold' | 'driver';
