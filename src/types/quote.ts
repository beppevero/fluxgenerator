...
export interface Service {
  ...
  nome: string;
  descrizione: string;
  categoria: 'dispositivi' | 'fleet_vehicles' | 'fleet_truck' | 'fleet_trailers' | 'tractor' | 'asset' | 'piattaforme' | 'servizi_aggiuntivi' | 'centrale_operativa' | 'accessori' | 'software' | 'driver' | 'fleet_missioni';
